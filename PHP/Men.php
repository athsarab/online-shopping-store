...
<head>
    ...
    <title>Men's Collection - KIYARAA</title>
    ...
    <style>
        ...
        .men1 h2       { font-size: 15px; padding: 0 12px; margin-top: 14px; }
        .men1 p.price  { color: #555; font-size: 14px; margin: 4px 0; }
        .men1 p.sizes  { color: #777; font-size: 13px; margin: 4px 0; }
        .men1 .shop-item-button {
        ...
        @media (max-width: 1024px) { .men1 { width: calc(33.33% - 20px); } }
        @media (max-width: 700px)  { .men1 { width: calc(50% - 20px); } }
    </style>
</head>
<body>
...
<center><h1>Men's Collection</h1></center>
<br><br>
...
<section class="container content-section">
    ...
    <?php if(count($products) === 0): ?>
        <div class="no-products">
            ...
            <p>No products in Men's collection yet.</p>
