...
<section class="container content-section">
 <div class="women-list1">
    <div class="women1">
        <div class="p1">
      <img class="product-image" src="../PICS/image1.jpeg" alt="Product 1">
    ...
    <div class="women1">
        <div class="p2">
      <img class="product-image"src="../PICS/image2.jpeg" alt="Product 2">
	...
	<div class="women1">
        <div class="p3">
      <img class="product-image" src="../PICS/image3.jpeg" alt="Product 2">
...
<section class="container content-section">
   ...
   <div class="women-list2">
    <div class="women2">
        <div class="p4">
      <img class="product-image" src="../PICS/image4.jpeg" alt="Product 1">
    ...
    <div class="women2">
        <div class="p5">
      <img class="product-image" src="../PICS/image5.jpeg" alt="Product 1">
	...
	<div class="women2">
        <div class="p6">
      <img class="product-image"src="../PICS/image6.jpeg" alt="Product 1">
  ...
  <section class="container content-section">
   <div class="women-list3">
    <div class="women3">
        <div class="p7">
      <img class="product-image"src="../PICS/image7.jpeg" alt="Product 1">
    ...
    <div class="women3">
        <div class="p8">
      <img class="product-image"src="../PICS/image8.jpeg" alt="Product 1">
	...
	<div class="women3">
        <div class="p9">
      <img class="product-image"src="../PICS/image9.jpeg" alt="Product 1">
      <br><br>
